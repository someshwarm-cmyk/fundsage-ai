...
FUND_POOL = {
    ...
    "debt": [
        {"code": "119016", "name": "HDFC Short Term Debt Fund"},
        {"code": "119816", "name": "SBI Short Term Debt Fund"},
        {"code": "119739", "name": "Kotak Bond Short Term Fund"},
        {"code": "120754", "name": "ICICI Prudential Short Term Fund"},
        {"code": "119390", "name": "Nippon India Short Term Fund"},
    ],
    "hybrid": [
...
def generate_training_data():
    ...
    for p in profiles:
        ...
        for _ in range(200):
            ...
            ft_match   = 1.0
            feat = [r1, r3, r5, r10, risk,
                    risk_map[p["risk"]], horizon_map[p["horizon"]],
